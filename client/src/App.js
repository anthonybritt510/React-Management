...
import { Paper, Table, TableHead, TableBody, TableRow, TableCell, CircularProgress } from '@material-ui/core';
...
class App extends React.Component {
  ...
  render() {
    ...
    const cellList = ['ID', 'Image', 'Name', 'Birthday', 'Gender', 'Job Position', 'Option'];
    const filterdComponent = (data) => {
      data = data.filter((c) => {
        ...
        <AppBar position="static">
          <Toolbar>
            ...
            <Typography className={classes.title} variant="h6" noWrap>
              Customer Management System (고객관리체계)
            </Typography>
        ...
        <Paper className={classes.paper}>
          <Table className={classes.table}>
            ...
            { this.state.customers ? 
              filterdComponent(this.state.customers) 
