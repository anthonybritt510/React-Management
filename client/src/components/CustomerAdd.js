                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <label htmlFor="raised-button-file">
                            <Button variant="contained" color="primary" component="span" name="file">{this.state.fileName === '' ? 'Select Profile Image' : this.state.fileName}</Button>
                        </label><br/>
                        ...
                        <TextField label="Job Position" type="text" name="job" value={this.state.job} onChange={this.handleValueChange} /><br/>
